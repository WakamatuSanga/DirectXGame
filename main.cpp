...
#pragma region CreateDescriptorHeap関数
...
#pragma region ウィンドウ
	...
	HWND hwnd = CreateWindow(
		...
		L"CG2_LE2D_26_ワカマツ_サンガ", // タイトルバーの文字(なんでもいい)
...
#pragma region Material用
	...
	// 今回は赤を書き込んでいる
	*materialDara = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
...
#pragma endregion
	...
	MSG msg{};
	// ImGui の初期化。詳細はさして重要ではないので解説は省略する。
	IMGUI_CHECKVERSION();
	ImGui::CreateContext();
	...
	while (msg.message != WM_QUIT) {
		...
		if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
			...
			//ImGui::DragFloat("rotate.y" &transfrom.translate.z, 0.1f);
			ImGui::End();
